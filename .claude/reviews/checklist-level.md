...
- [ ] `hintProgram` é uma solução válida e testada (mesmo se não for a ótima) — prova que a fase é solucionável, mas **não** aparece para o jogador.
- [ ] `hintText` preenchido: uma frase curta (até 100 caracteres) que aponta como passar, sem entregar a resposta — é o que aparece como Dica na tela de Tentativa Falha.
