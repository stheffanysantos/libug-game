...
final world4Levels = <CodeQuestLevel>[
  ...
  CodeQuestLevel(
    ...
    questions: const [
      ...
      CodeQuestQuestion(
        prompt: "Qual desses comandos já é condicional por si só, sem precisar de um 'se' separado?",
        answerKind: CodeQuestAnswerKind.blockIcon,
        blockOptions: [BlockType.repeat, BlockType.rescueIfCharacterHere, BlockType.turnLeft],
        correctOptionIndex: 1,
        explanation: "'Se tiver, resgate' já é um comando condicional — ele só resgata quando tem um personagem na casa.",
      ),
    ],
  ),
  CodeQuestLevel(
  ...
  CodeQuestLevel(
    ...
    questions: const [
      ...
      CodeQuestQuestion(
        ...
        answerKind: CodeQuestAnswerKind.blockIcon,
        blockOptions: [BlockType.walk, BlockType.rescueIfCharacterHere, BlockType.turnRight],
        correctOptionIndex: 1,
        explanation: "'Se tiver, resgate' + 'Repetir 3×' resolve um corredor inteiro sem precisar saber onde cada personagem está.",
      ),
      CodeQuestQuestion(
