...
SLIDES = {
    ...
    "world2_0": "Como jogar: Resgate de Personagens. Vamos aprender rapidinho:",
    "world2_1": "Pelo caminho tem personagens perdidos. Bit, Chip, Loopy e Libug estão esperando por você!",
    "world2_2": "Pra resgatar alguém, é só Andar até a casa dele. Planeje um caminho que passe por todos até chegar no alvo.",
    "world2_3": "Chegar no alvo com a quantidade errada de resgates também é falha. O painel Resgatados mostra quantos você já tem.",
    ...
    "recap2_0": "Trilha 1 completa! Você aprendeu a planejar o caminho, passando por todos os personagens perdidos antes de chegar. Agora vem a Trilha Construtores de Lógica: pintar desenhos no tabuleiro e montar programas que resolvem contas de verdade!",
